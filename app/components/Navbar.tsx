      ...
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 lg:px-12">
          ...
          <a href="/" className="flex items-center gap-2 group">
            <span
              className={`font-[var(--font-script)] text-3xl transition-colors duration-300 ${
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-40 bg-plum flex flex-col items-center justify-center gap-8"
          >
            {navLinks.map((link, i) => (
              <motion.a
                key={link.name}
